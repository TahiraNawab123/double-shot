...
const menu = [
  { id: 'espresso', name: 'Espresso', description: 'A clean, syrupy double shot.', price: 280, category: 'Coffee', image: '/double-shot-hero.png' },
  { id: 'flat-white', name: 'Flat White', description: 'Velvety microfoam, double ristretto.', price: 520, category: 'Coffee', image: '/double-shot-flat-white.png' },
  { id: 'iced-mocha', name: 'Iced Mocha', description: 'Cocoa, espresso, milk, over ice.', price: 650, category: 'Cold', image: '/double-shot-hero.png' },
  { id: 'cardamom-bun', name: 'Cardamom Bun', description: 'Buttery layers, toasted sugar.', price: 480, category: 'Bakes', image: '/double-shot-cardamom-bun.png' },
  { id: 'avocado-toast', name: 'Avocado Toast', description: 'Sourdough, lemon, za’atar, chilli.', price: 890, category: 'Plates', image: '/double-shot-avocado-toast.png' },
  { id: 'basque-cheesecake', name: 'Basque Cheesecake', description: 'Burnt top, soft centre, sea salt.', price: 720, category: 'Sweet', image: '/double-shot-cardamom-bun.png' },
]
