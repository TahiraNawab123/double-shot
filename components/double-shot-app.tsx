...
const menu = [
  { id: 'espresso', name: 'Espresso', description: 'A clean, syrupy double shot.', price: 280, category: 'Coffee', image: '/double-shot-latte.png' },
  { id: 'flat-white', name: 'Flat White', description: 'Velvety microfoam, double ristretto.', price: 520, category: 'Coffee', image: '/double-shot-cheesecake.png' },
  { id: 'iced-mocha', name: 'Iced Mocha', description: 'Cocoa, espresso, milk, over ice.', price: 650, category: 'Cold', image: '/double-shot-iced.png' },
  { id: 'cardamom-bun', name: 'Cardamom Bun', description: 'Buttery layers, toasted sugar.', price: 480, category: 'Bakes', image: '/double-shot-croissant.png' },
  { id: 'avocado-toast', name: 'Avocado Toast', description: 'Sourdough, lemon, za’atar, chilli.', price: 890, category: 'Plates', image: '/double-shot-hero-hands.png' },
  { id: 'basque-cheesecake', name: 'Basque Cheesecake', description: 'Burnt top, soft centre, sea salt.', price: 720, category: 'Sweet', image: '/double-shot-cheesecake.png' },
]
...
function Story() { return <section className="content-page"><p className="eyebrow">OUR STORY</p><h1>A room for<br /><em>good company.</em></h1><div className="story-layout"><div><p className="story-copy">Double Shot started with one simple idea: coffee tastes better when there is nowhere else you need to be. A neighbourhood living room for Model Town, built around thoughtful coffee, generous plates, and the people who make a place feel like home.</p><div className="quote">“Stay for one. Stay for the afternoon.”</div></div><div className="story-image"><Image src="/double-shot-interior.png" alt="The Double Shot café interior" fill sizes="(max-width: 800px) 100vw, 45vw" /></div></div></section> }
